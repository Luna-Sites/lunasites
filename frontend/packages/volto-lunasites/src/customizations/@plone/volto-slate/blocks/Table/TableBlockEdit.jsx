...
class Edit extends Component {
  ...
  handleSort(columnIndex) {
    if (!this.props.data.table?.sortable) return;
    
    let direction = 'ascending';
    if (this.state.sortConfig.key === columnIndex && this.state.sortConfig.direction === 'ascending') {
      direction = 'descending';
    }
    this.setState({ sortConfig: { key: columnIndex, direction } });
  }
  ...
  getTableThemeStyles() {
    ...
    const currentTheme = this.props.data.table?.table_theme || 'primary_table';
    const themeStyles = tableVariations[currentTheme] || tableVariations.primary_table;
  ...
  render() {
    ...
    const themeStyles = this.getTableThemeStyles();

    // Sort rows if sorting is active
    if (this.props.data.table?.sortable && this.state.sortConfig.key !== null) {
      rows = [...rows].sort((a, b) => {
        const aValue = a.cells[this.state.sortConfig.key]?.value?.[0]?.children?.[0]?.text || '';
        const bValue = b.cells[this.state.sortConfig.key]?.value?.[0]?.children?.[0]?.text || '';
          ...
          <div className="toolbar">
            <Button.Group>
              <Button
                ...
                title={this.props.intl.formatMessage(messages2.insertRowBefore)}
                aria-label={this.props.intl.formatMessage(
                  messages2.insertRowBefore,
                )}
              >
            ...
            <Button.Group>
              <Button
                ...
                title={this.props.intl.formatMessage(messages2.insertRowAfter)}
                aria-label={this.props.intl.formatMessage(
                  messages2.insertRowAfter,
                )}
              >
            ...
            <Button.Group>
              <Button
                ...
                title={this.props.intl.formatMessage(messages2.deleteRow)}
                aria-label={this.props.intl.formatMessage(messages2.deleteRow)}
              >
            ...
            <Button.Group>
              <Button
                ...
                title={this.props.intl.formatMessage(messages2.insertColBefore)}
                aria-label={this.props.intl.formatMessage(
                  messages2.insertColBefore,
                )}
              >
            ...
            <Button.Group>
              <Button
                ...
                title={this.props.intl.formatMessage(messages2.insertColAfter)}
                aria-label={this.props.intl.formatMessage(
                  messages2.insertColAfter,
                )}
              >
            ...
            <Button.Group>
              <Button
                ...
                title={this.props.intl.formatMessage(messages2.deleteCol)}
                aria-label={this.props.intl.formatMessage(messages2.deleteCol)}
              >
                  ...
                  {headers.map((cell, cellIndex) => (
                    <Table.HeaderCell
                      ...
                      style={{
                        ...
                        cursor: this.props.data.table?.sortable ? 'pointer' : 'default',
                      }}
                      onClick={() => this.handleSort(cellIndex)}
                    >
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                        ...
                        />
                        {this.props.data.table?.sortable && (
                          <span style={{ marginLeft: '0.5rem', fontSize: '0.8rem', pointerEvents: 'none' }}>
                            {this.state.sortConfig.key === cellIndex
                ...
                <Table.Row key={row.key}>
                  {map(row.cells, (cell, cellIndex) => (
                    <Table.Cell
                      ...
                      verticalAlign="middle"
                      style={
                        this.props.data.table.striped && rowIndex % 2 === 1
...
export default connect(mapStateToProps)(injectIntl(Edit));