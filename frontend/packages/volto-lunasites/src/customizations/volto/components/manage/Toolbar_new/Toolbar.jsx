...
class Toolbar extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      showPageBrowser: false, // Add state for PageTemplateBrowser
    };
  }
  ...
  handleCreatePage = (pageTemplate) => {
    ...
    const addContentTypeRoute = `${path}/add?type=${pageTemplate.contentType}`;
    window.location.href = addContentTypeRoute;
    this.setState({ showPageBrowser: false });
  };

  toggleMenu = (e, selector) => {
    // If it's the 'types' selector (Add button), open PageTemplateBrowser instead
    if (selector === 'types') {
      this.handleOpenPageBrowser(e);
      return;
    }
    ...
    return (
      this.props.token && (
        <>
          ...
          {/* PageTemplateBrowser Modal */}
          <PageTemplateBrowser
            open={this.state.showPageBrowser}
            onClose={() => this.setState({ showPageBrowser: false })}
