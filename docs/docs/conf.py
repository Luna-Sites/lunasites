...
# LunaSites build configuration file
...
linkcheck_ignore = [
    ...
    r"https://github.com/luna-sites/lunasites/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/luna-sites/lunasites",
    ...
    "repository_url": "https://github.com/luna-sites/lunasites",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/luna-sites/lunasites/edit/main/docs/",
# }
...
ogp_site_name = "LunaSites Documentation"
ogp_type = "website"
...
htmlhelp_basename = "LunaSitesDocumentation"
...
latex_documents = [
    (
        "index",
        "LunaSitesDocumentation.tex",
        "LunaSites Documentation",
