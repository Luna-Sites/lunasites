...
You need either a Ubuntu or Debian based system for luna-sites.com, enable SSH, and install a supported version of Python 3 on that system.
...
Deploy the stack defined in `devops/stacks/luna-sites.com.yml` to the remote server with:
