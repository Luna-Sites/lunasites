...
2. Go to your repository at [/Luna-Sites/lunasites](https://github.com/luna-stes/lunasites).
...
- [Backend Tests Workflow](https://github.com/luna-stes/lunasites/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/luna-stes/lunasites/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/luna-stes/lunasites-backend`) and Frontend (`ghcr.io/luna-stes/lunasites-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of luna-sites.com](https://github.com/luna-stes/lunasites/actions/workflows/manual-deploy.yml).
